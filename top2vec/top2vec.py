...
# a =  word_tokenize(" anh tâm đẹp trai nhất thế giới ")
# print(a)
class Top2Vec:
    """
    Top2Vec
    ...
    def __init__(self, documents, min_count=10, speed="learn", use_corpus_file=False, document_ids=None,
        ...
        umap_model = umap.UMAP(n_neighbors=2,
                               n_components=5,
    ...
    def get_num_topics(self, reduced=False):
        ...
        if reduced:
            ...
            return "reduce" + len(self.topic_vectors_reduced)
        else:
